...
covid19_PH_edited = covid19_PH.loc[:, ['Case No.',
                        'Sex',
                        'Age',
                        'Nationality',
                        'Travel History',
...
def confirmed_date_PH(maps):
    ...
    return df.hvplot.points(x='Residence Long', y='Residence Lat', geo=True, color='darkorange', alpha=0.8,
                            width=600, height=450, global_extent=False, tiles=maps,
...
def admitted_date_PH(maps):
    ...
    return df.hvplot.points(x='Longitude', y='Latitude', geo=True, color='magenta', alpha=0.8,
                            width=600, height=450, global_extent=False, tiles=maps, title="Mapa ng mga kaso ng COVID-19 sa Bansa (Nasa Ospital)",
                            ylim=(0, 25), xlim=(115, 130))
...
def dead_date_PH(maps):
    ...
    return df.hvplot.points(x='Residence Long', y='Residence Lat', geo=True, color='red', alpha=0.8,
                            width=600, height=450, global_extent=False, tiles=maps, title="Mapa ng mga kaso ng COVID-19 sa Bansa (Mga Namatay)",
                            ylim=(0, 25), xlim=(115, 130))
...
def recovered_date_PH(maps):
    ...
    return df.hvplot.points(x='Residence Long', y='Residence Lat', geo=True, color='royalblue', alpha=0.8,
                            width=600, height=450, global_extent=False, tiles=maps, title="Mapa ng mga kaso ng COVID-19 sa Bansa (Mga Gumaling)",
                            ylim=(0, 25), xlim=(115, 130))
...
covid19_PH_area_graph = covid19_PH_line.hvplot.area(x='Date Announced', y=['Cumulative Admitted',
                                                                           'Cumulative Dead',
                                                                           'Cumulative Recovered'],
                                                    width=900, height=450, stacked=False,
                                                    title = 'Graph ng Nadadagdag na Kaso ng COVID-19 sa Bansa')
...
covid19_PH_line_tab = covid19_PH_line.hvplot.table(width=1000, height=250,
...
age_plot = age_PH.hvplot.hist(y='age', bins=15, bin_range=(0,100),
                         width=400, height=250, cmap='Accent',
...
place_PH_tab = place_PH_valid.hvplot.table(width=950, height=400)
...
gender_PH_plot = gender_PH.hvplot.bar(x='Sex', y='count',
                                      ...
                                      invert=False, width=350, height=250, flip_yaxis=False,
...
hospitals_PH_plot = hospitals_PH.head(10).hvplot.bar(x='Hospital', y='Patients Admitted',
                                      width=900, height=450, legend=False,
                                      color='Hospital', cmap='glasbey_light',
                                      invert=True, flip_yaxis=True, shared_axes=False,
                                      title = 'Top 10 na mga Ospital sa Pilipinas na may Pinkamaraming Naka-admit na Kaso ng COVID-19')

hospitals_PH_table = hospitals_PH.hvplot.table(x='Hospital', y='Patients Admitted', width=500, height=200,)
